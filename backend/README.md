...
## Project Structure
    ...
    ├── emigrefigmatest_33650  # Django project configurations
...
1. Clone this repo and `cd emigrefigmatest_33650`
...
2. Clone this repo and `cd emigrefigmatest_33650`
